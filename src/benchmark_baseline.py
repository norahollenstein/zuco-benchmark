...
This code can be used for a first baseline in the benchmarking task. 
"""
    ...
    for subject in subjects:
        ...
        for feature_set in config.feature_sets:
            ...
            if os.path.isfile(feature_path):
                ...
                if train_feats:
                    f_nr = dh.read_mat_file(dir + "results" + subject + "_NR.mat")
                    f_tsr = dh.read_mat_file(dir + "results" + subject + "_TSR.mat")
                    ...
                    f = dh.read_mat_file(dir + "results" + subject + ".mat")
